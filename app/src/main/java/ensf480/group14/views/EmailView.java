...
public class EmailView {
  ...
  public JPanel display(Email email, Listener listen) {
    ...
    JButton deleteButton = new JButton("Delete Email"); // Removes the email from the inbox
    deleteButton.addActionListener(listener);
    footer.add(deleteButton);

    JButton backInboxButton = new JButton("Back to Inbox"); // Removes the email from the inbox
    backInboxButton.addActionListener(listener);
    footer.add(backInboxButton);
